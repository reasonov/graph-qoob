    ...
    <div class="modal-payment">
      <div class="payment__wrapper">
        ...
        <div class="payment__bottom">
          <router-link :to="{name: 'billingPayments'}" class="payment__download" v-if="activeModal === 2">Скачать</router-link>
...
import paymentData from "@/components/Dashboard/Billing/payment-data";
import paymentInvoice from "@/components/Dashboard/Billing/payment-invoice";
import closeButton from "@/components/Dashboard/Billing/close-button";
import arrowRight from "@/components/Dashboard/Billing/icons/arrow-right";
